...
**ФИО студента** - Сычёв Кирилл Владимирович 
**Направление подготовки** - 38.03.05 (Бизнес-информатика)
**Номер группы** - БИЗ-Б-О-Д-2024-1
**Период прохождения практики** - 27.05.2026-10.06.2026

## Структура репозитория

- [Задание 1. Анализ](#) — `task1-analysis/analysis.md`
- [Задание 2. BPMN-диаграммы](#) — `task2-bpmn/`
...
- [Задание 4. Программирование на Python](#) — `task4-python/`
  ...
  - [Мини-проект](task4-python/mini_project.py)
